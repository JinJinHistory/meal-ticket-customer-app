...
import ChargingHistoryItem from "./charging-history-item";
		...
		<>
			<SafeAreaView>
				...
				>
					...
					{companyTickets.map((item: ResponseCompanyTicketModel, index: number) => (<ChargingHistoryItem key={index} ticketItem={item} />))}
				</ScrollView>
			</SafeAreaView>
		</>
	);
